...
public class CrateContainer extends TKContainer {

    public static final ContainerType<TKContainerAdapter> TYPE = TKContainerAdapter.typeOf(CrateContainer::new);
    public static final TranslationTextComponent NAME = new TranslationTextComponent("container." + Technicalities.MODID + ".crate");
    ...
    public CrateContainer(int windowId, PlayerInventory playerInventory, Inventory storageInv) {
        super(TYPE, windowId);

        Region storage = addSlots(8, 18, STORAGE_ROWS, STORAGE_COLUMNS, storageInv);
    ...
    private CrateContainer(int windowId, PlayerInventory playerInventory) {
